    ...
    const fetchCategories = async () => {
      try {
        const catsResponse = await fetch(
          'https://wordpress-inertia-starter.test/wp-json/wp/v2/categories'
        );
    ...
    const fetchTotalPosts = async () => {
      try {
        const response = await fetch(
          `https://wordpress-inertia-starter.test/wp-json/wp/v2/posts?per_page=${postsPerPage}`
        );
    ...
    try {
      ...
      if (selectedCategory) {
        postsResponse = await fetch(
          `https://wordpress-inertia-starter.test/wp-json/wp/v2/posts?per_page=${postsPerPage}&page=${currentPage}&categories=${selectedCategory}`
        );
      } else {
        postsResponse = await fetch(
          `https://wordpress-inertia-starter.test/wp-json/wp/v2/posts?per_page=${postsPerPage}&page=${currentPage}`
        );
      }
